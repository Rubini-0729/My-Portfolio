...
function showSection(sectionId) {
   ...
   // Ensure all menu items are in visible state before transitioning
   menuItems.forEach((item) => {
   ...
   setTimeout(() => {
      ...
      // NOTE:
      // Contact form is now handled by FormSubmit (normal HTML form POST),
      // so we must NOT bind a JS submit handler that calls preventDefault().
...
// (Optional, only if you also use inline onclick elsewhere and they fail)
